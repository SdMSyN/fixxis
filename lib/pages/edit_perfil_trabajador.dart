...
class EditPerfilTrabajador extends StatefulWidget{
  EditPerfilTrabajador({Key key, this.userId, this.userKey}) : super(key: key);
  final String userId;
  final String userKey;
  
  @override 
  _EditPerfilTrabajadorState createState() => new _EditPerfilTrabajadorState();
}

class _EditPerfilTrabajadorState extends State<EditPerfilTrabajador>{
  // variables
